<?php
$id = $_GET['ListarTermo'];
 $query = DBRead('ecommerce_termos','*', "WHERE id_atributo = '{$id}'"); ?>
...
<div class="card">
  ...
  <?php } else { ?>
    ...
    <?php if (checkPermission($PERMISSION, $_SERVER['SCRIPT_NAME'], 'categoria', 'adicionar')) { ?>
      <div class="alert alert-info">Nenhum Termo adicionado até o momento, <a href="?AdicionarTermo">clique aqui</a> para adicionar.</div>
      <?php } ?>
    </div>
  <?php } ?>
</div>
